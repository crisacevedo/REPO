...
$q = "UPDATE categoria set rock_reg=:rock_reg,rock_pop=:rock_pop,rock_ska=:rock_ska,rock_jazz=:rock_jazz,reg_pop=:reg_pop,reg_ska=:reg_ska,reg_jazz=:reg_jazz,pop_ska=:pop_ska,pop_jazz=:pop_jazz,ska_jazz=:ska_jazz,grado=:grado WHERE 	idu='$idu' and idc='$cancionid'";
