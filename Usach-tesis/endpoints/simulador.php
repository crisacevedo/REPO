...
if (count($verificacion) !== 1){
    ...
    $q = "INSERT INTO categoria (idu,idc,animo,rock_reg, rock_pop, rock_ska, rock_jazz, reg_pop, reg_ska, reg_jazz, pop_ska, pop_jazz, ska_jazz)
	VALUES (:user_id,:song_id,:animo,:rock_reg, :rock_pop, :rock_ska, :rock_jazz, :reg_pop, :reg_ska, :reg_jazz, :pop_ska, :pop_jazz, :ska_jazz)";
    $query = $db->prepare($q);
