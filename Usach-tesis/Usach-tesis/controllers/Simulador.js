...
//       console.log("hola");
     ...
     arreglo[1][0]= $scope.ObtEvaInfo.ObtEva2elem1;  
         ...
         arreglo[2][0]= $scope.ObtEvaInfo.ObtEva3elem1;  
         arreglo[2][1]= $scope.ObtEvaInfo.ObtEva3elem2;  
        ...
        arreglo[3][0]= $scope.ObtEvaInfo.ObtEva4elem1; 
         arreglo[3][1]= $scope.ObtEvaInfo.ObtEva4elem2;  
         arreglo[3][2]= $scope.ObtEvaInfo.ObtEva4elem3;  
         arreglo[3][3]= $scope.ObtEvaInfo.ObtEva4elem4;  
         arreglo[3][4]= $scope.ObtEvaInfo.ObtEva4elem5;  
        
        arreglo[4][0]= $scope.ObtEvaInfo.ObtEva5elem1; 
         arreglo[4][1]= $scope.ObtEvaInfo.ObtEva5elem2;  
         arreglo[4][2]= $scope.ObtEvaInfo.ObtEva5elem3;  
         arreglo[4][3]= $scope.ObtEvaInfo.ObtEva5elem4;  
